...
export KEYTIMEOUT=5 # Faster esc key for vi keybindings
...
# Some keybinds, most taken from Arch wiki
typeset -g -A key
...
[[ -n "${key[Shift-Tab]}" ]] && bindkey -- "${key[Shift-Tab]}"  menu-complete # For completion
